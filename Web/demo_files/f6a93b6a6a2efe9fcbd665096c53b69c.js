(function(a, narrow_screen_ad,narrow_screen_w,narrow_screen_h,narrow_screen_isActive,wide_screen_ad,wide_screen_w,wide_screen_h,wide_screen_isActive) {
	...
	function resizeContainerDiv(){
		//if(isXY){
			...
			//排除影视频道，娱乐-综艺频道，视频首页频道的响应式判断
			if(/(http:\/\/tv\.v\.ifeng\.com)|(http:\/\/v\.ifeng\.com(((\/)?$)|(\/ent\/zongyi)))/.test(location.href)){
				containerWidth = getWidth() >= 1300 ? "1230px" : "1000px";		
			}
...
})(a, narrow_screen_ad,narrow_screen_w,narrow_screen_h,narrow_screen_isActive,wide_screen_ad,wide_screen_w,wide_screen_h,wide_screen_isActive);